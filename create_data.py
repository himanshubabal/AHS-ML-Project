...
#read the data
df = pd.read_csv("data/22/22_AHS_COMB_diag_hotData_with_0.csv", header = 0)
...
#writing to file
df_subsets.to_csv("data/22/22_AHS_COMB_diag_hotData_with_0_subset.csv", header = True)
df_subsets1.to_csv("data/22/22_AHS_COMB_diag_hotData_with_0_subset1.csv", header = True)
df_subsets2.to_csv("data/22/22_AHS_COMB_diag_hotData_with_0_subset2.csv", header = True)
df_subsets3.to_csv("data/22/22_AHS_COMB_diag_hotData_with_0_subset3.csv", header = True)
df_subsets4.to_csv("data/22/22_AHS_COMB_diag_hotData_with_0_subset4.csv", header = True)
df_subsets5.to_csv("data/22/22_AHS_COMB_diag_hotData_with_0_subset5.csv", header = True)
df_subsets6.to_csv("data/22/22_AHS_COMB_diag_hotData_with_0_subset6.csv", header = True)
